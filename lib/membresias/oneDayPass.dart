    ...
    void initState() {
      Future.delayed(Duration.zero, (){
        ...
        setState(() {
          ...
          this.gymId = data["class"]["idGimnasio"];
          this.clientId = data["userId"];
          this.date = data["date"];
          this.schedule = data["schedule"];
          this.fecha_clase = data["fecha_selected"];
        });
      });
                        ...
                        child: RaisedButton(
                            ...
                            onPressed: () async {
                              ...
                              ComprarMembresiasCubit cmc = context.read<ComprarMembresiasCubit>();
                                ...
                                dynamic dobj = await sw.buyOneDayPass(clientId: cmc.idCliente, token: pm.tokenId, idClase:this.idClase, gymId:this.gymId, date:this.date, schedule: this.schedule, fecha_clase: this.fecha_clase);
