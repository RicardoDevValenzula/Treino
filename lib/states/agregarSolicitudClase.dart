...
class AgregarSolicitudCubit extends Cubit<dynamic> {
  ...
  Future<bool> agregarSolicitud({String idClase, String idCliente, String idGym, String fecha}) async {
    // var dio = Dio();
    ...
    try {
      await http
          .post( Uri.parse("https://treino.club/demo/api/AppMovil/agregarSolicitud"),
              body: json.encode({
